...
export type BlockType = 'text' | 'math' | 'table' | 'image' | 'script' | 'formula' | 'data' | 'cad' | 'pdf';
...
export type Block = TextBlock | ScriptBlock | FormulaBlock | ImageBlock | TableBlock | DataImportBlock | CADBlock | PdfBlock;
